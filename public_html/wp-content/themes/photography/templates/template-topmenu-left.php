	        ...
	        <div id="nav_wrapper">
	        		...
	        		<div id="menu_border_wrapper">
	        			<?php 	
	        				...
	        				if(empty($page_menu))
	    					{
	    		    			...
	    		    			{
	    			    			echo '<div class="notice">'.esc_html__('Setup Menu via Wordpress Dashboard > Appearance > Menus', 'photography' ).'</div>';
	    		    			}
	    	    			}
	    	    			else
	    				    {
		    	...
		    	<div id="logo_right_button">
					...
					<div class="post_share_wrapper">
						<a id="page_share" class="tooltip" href="javascript:;" title="<?php esc_html_e('Share', 'photography' ); ?>"><i class="fa fa-share-alt"></i></a>
					</div>
					<?php
						global $photography_page_gallery_id;
						$post_type = get_post_type();
