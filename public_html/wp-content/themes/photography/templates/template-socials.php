...
<div class="social_wrapper">
    <ul>
    	<?php
    		...
    		{
    	?>
    	<li class="facebook"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="Facebook" href="<?php echo esc_url($pp_facebook_url); ?>"><i class="fa fa-facebook-official"></i></a></li>
    	<?php
    		}
    	?>
    	<?php
    		...
    		{
    	?>
    	<li class="twitter"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="Twitter" href="//twitter.com/<?php echo esc_attr($pp_twitter_username); ?>"><i class="fa fa-twitter"></i></a></li>
    	<?php
    		}
    	?>
    	<?php
