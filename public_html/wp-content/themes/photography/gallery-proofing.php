			        ...
			        <div class="portfolio_classic_icon_wrapper">
					    <div class="portfolio_classic_icon_content">
					    	<div class="portfolio_classic_icon_content_middle">
						    	<a data-rel="photography_gallery_<?php echo esc_attr($current_page_id); ?>" title="<?php esc_html_e('View', 'photography' ); ?>" id="image<?php echo esc_attr($photo_id); ?>_image" <?php echo photography_get_lightbox_caption_attr($photo_id, false); ?> class="fancy-gallery tooltip" href="<?php echo esc_url($image_url[0]); ?>">
