 ...
 $wl_nls_options = weblizar_nls_get_options(); 
	...
	*/
	...
	// 			$wl_nls_options[$key]=sanitize_text_field($_POST[$key]);	
	// 		}	
	// 		if(isset($_POST['subscriber_form_gdpr']))
	// 		{  $wl_nls_options['subscriber_form_gdpr'] = $_POST['subscriber_form_gdpr'];
	// 		} else {  $wl_nls_options['subscriber_form_gdpr'] = "off";	} 
			
	// 		update_option('weblizar_nls_options_gdpr', stripslashes_deep($wl_nls_options));
