...
.newsletter-api-form-theme1 .newsletter_form1 {
	background-color: <?php echo esc_attr($wl_nls_options['sub_form_bg_color']) ?>!important;
}
...
.newsletter-api-form-theme1 .newsletter_form1_social-icons .newsletter_form1_icon{ 
	font-size:<?php echo isset($wl_nls_options['link_size'] ) ? $wl_nls_options['link_size'] : '';?>px!important;
}
