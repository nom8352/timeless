		...
		<div class="container-fluid top">
			<div class="row">
				<div class="col-md-8 col-sm-8">
					<h2><img src="<?php echo plugin_dir_url( __FILE__ ) ?>images/logo.png" alt="Weblizar" style="width: 150px;height: 100px;"  /> <span style="font-size:24px;font-weight:bold;top: 6px;position: relative;left: 20px;color: #fff;"><?php esc_html_e(NLS_PLUGIN_NAME,'NLS_TEXT_DOMAIN');?></span></h2>
				</div>	  
