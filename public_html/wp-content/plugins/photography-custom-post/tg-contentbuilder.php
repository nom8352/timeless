...
function ppb_contact_map_func($atts, $content) {
    ...
    if(is_array($pp_contact_form) && !empty($pp_contact_form))
    {
	    ...
	    {
	    	$return_html.= '<br/><br/><input id="gdpr" name="gdpr" type="checkbox" class="required_field gdpr" value=""/>
	    <label for="gdpr" class="gdpr_label">'.esc_html__('I consent to ', 'photography-custom-post' ).get_bloginfo('name').esc_html__(' collecting my details through this form.', 'photography-custom-post' ).'</label>';
	   	}
